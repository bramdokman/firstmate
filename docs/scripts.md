...
| `fm-fleet-reconcile.sh`  | Report only disagreements between durable fleet claims and read-only GitHub observations, holding draft changes out of vacuous-green scope because a draft asserts no readiness to disagree with |
