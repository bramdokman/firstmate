...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  completion-receipts.jsonl  append-only typed task outcomes written best-effort by teardown; bin/fm-completion-receipt-lib.sh owns the exact schema
